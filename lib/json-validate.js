...
// TODO XXX:
//  - move tests to expect
//  - add browser tests
//  - document the interface
//  - explain why it's different from the JSON Schema implementations
...
(function () {
    ...
    JSONValidate.prototype = {
        registerSchema: function (id, schema) {
            this.env[id] = schema;
        }
    ...
    ,   validateAny: function (obj, schema, errors) {
            return true;
        }
    ...
    global.JSONValidate = JSONValidate;
}());
